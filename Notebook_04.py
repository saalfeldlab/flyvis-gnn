...
# cell-type structure, we apply UMAP [1] to an augmented feature vector
...
# from the `metrics.txt` files generated by `data_plot`.
...
# ## References
#
# [1] L. McInnes, J. Healy, and J. Melville, "UMAP: Uniform Manifold
